...
public class LinksAdapter extends RecyclerView.Adapter<LinksAdapter.CategoriesAdapterViewHolder> {

    private final ArrayList<Pair<String,String>> categories;
    private final ItemClickListener mClickListener;

    public LinksAdapter(ArrayList<Pair<String, String>> categories, ItemClickListener mClickListener) {
    ...
    @Override
    public void onBindViewHolder(@NonNull LinksAdapter.CategoriesAdapterViewHolder holder, int position) {
